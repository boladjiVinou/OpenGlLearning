#include "HelloTriangle_3.h";
void HelloTriangle_3::framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
	glViewport(0, 0, width, height);
}
void HelloTriangle_3::processInput(GLFWwindow *window)
{
	if (glfwGetKey(window, GLFW_KEY_ESCAPE) == GLFW_PRESS)
		glfwSetWindowShouldClose(window, true);
}

int HelloTriangle_3::run()
{
	glfwInit();
