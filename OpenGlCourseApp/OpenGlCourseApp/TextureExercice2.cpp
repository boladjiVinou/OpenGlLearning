#include "TextureExercice2.h";

void TextureExercice2::framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
	glViewport(0, 0, width, height);
}
void TextureExercice2::processInput(GLFWwindow *window)
{
	if (glfwGetKey(window, GLFW_KEY_ESCAPE) == GLFW_PRESS)
		glfwSetWindowShouldClose(window, true);
}
int TextureExercice2::run()
{
	glfwInit();
	...
	float vertices[] = {
		...
		-0.5f, 0.5f, 0.0f,		0.0f,2.0f  // top leftv
	};
